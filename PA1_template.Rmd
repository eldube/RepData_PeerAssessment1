...
The mean number of steps taken by the individual in a 5-minute interval is `r meanTotalNumberofSteps ` is and the median is `r medianTotalNumberofSteps `
...
The revised average number of steps per interval is `r revmeanTotalNumberofSteps ` is and the median is `r revmedianTotalNumberofSteps `. The chosen strategy has not changed the mean and the median.
